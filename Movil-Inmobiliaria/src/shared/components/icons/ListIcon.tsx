...
const ListIcono = ({ color, size }: { color: string; size: number }) => (
  <Svg
    width={size}
    height={size}
    // 1. Actualizamos el viewBox para que coincida con el nuevo SVG
    viewBox="0 0 100 100" 
    // 2. Cambiamos 'stroke' por 'fill' para colorear el nuevo ícono
    fill={color} 
  >
    {/* 3. Pegamos los nuevos paths dentro de sus grupos <G> */}
    <G>
